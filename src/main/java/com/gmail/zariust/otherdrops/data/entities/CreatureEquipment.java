...
public class CreatureEquipment {
    ...
    public String toString() {
        ...
        if (handsMain != null) msg += "!!" + handsMain + "%" + handsMainChance.toString() + "%";
        if (handsOff != null) msg += "!!" + handsOff + "%" + handsOffChance.toString() + "%";
        if (head != null) msg += "!!" + head + "%" + headChance.toString() + "%";
        if (chest != null) msg += "!!" + chest + "%" + chestChance.toString() + "%";
        if (legs != null) msg += "!!" + legs + "%" + legsChance.toString() + "%";
        if (boots != null) msg += "!!" + boots + "%" + bootsChance.toString() + "%";
    ...
    public boolean matches(CreatureEquipment equip) {
        ...
        if (head != null) if (head.getType() != equip.head.getType()) return false;
        if (chest != null) if (chest.getType() != equip.chest.getType()) return false;
        if (legs != null) if (legs.getType() != equip.legs.getType()) return false;
        if (handsMain != null) if (handsMain.getType() != equip.handsMain.getType()) return false;
        if (handsOff != null) if (handsOff.getType() != equip.handsOff.getType()) return false;
        if (boots != null) if (boots.getType() != equip.boots.getType()) return false;
