...
public class CreatureGroup {
    ...
    static {
        register("CREATURE_HOSTILE", "BLAZE", "BOGGED", "BREEZE", "CREAKING", "CREEPER", "ELDER_GUARDIAN", "ENDER_DRAGON", "ENDERMITE", "EVOKER", "GHAST", "GIANT", "GUARDIAN", "HOGLIN", "HUSK", "ILLUSIONER", "MAGMA_CUBE", "PARCHED", "PHANTOM", "PIGLIN_BRUTE", "PILLAGER", "RAVAGER", "SHULKER", "SILVERFISH", "SKELETON", "SLIME", "STRAY", "VEX", "VINDICATOR", "WARDEN", "WITCH", "WITHER", "WITHER_SKELETON", "ZOGLIN", "ZOMBIE", "ZOMBIE_VILLAGER");
        register("CREATURE_FRIENDLY", "ALLAY", "ARMADILLO", "AXOLOTL", "BAT", "CAMEL", "CAT", "CHICKEN", "COD", "COPPER_GOLEM", "COW", "DONKEY", "FROG", "GLOW_SQUID", "HAPPY_GHAST", "HORSE", "MUSHROOM_COW", "MOOSHROOM", "MULE", "OCELOT", "PARROT", "PIG", "RABBIT", "SALMON", "SHEEP", "SKELETON_HORSE", "SNIFFER", "SNOWMAN", "SNOW_GOLEM", "SQUID", "STRIDER", "TADPOLE", "TROPICAL_FISH", "TURTLE", "VILLAGER", "WANDERING_TRADER", "ZOMBIE_HORSE");
        register("CREATURE_NEUTRAL", "BEE", "CAVE_SPIDER", "DOLPHIN", "DROWNED", "ENDERMAN", "FOX", "GOAT", "IRON_GOLEM", "LLAMA", "NAUTILUS", "PANDA", "PIGLIN", "POLAR_BEAR", "PUFFERFISH", "SPIDER", "TRADER_LLAMA", "WOLF", "ZOMBIFIED_PIGLIN");
        register("CREATURE_ANIMAL", "ARMADILLO", "AXOLOTL", "BAT", "BEE", "CAMEL", "CAT", "CHICKEN", "COD", "COW", "DOLPHIN", "DONKEY", "FOX", "FROG", "GOAT", "GLOW_SQUID", "HORSE", "LLAMA", "MULE", "MUSHROOM_COW", "MOOSHROOM", "OCELOT", "PANDA", "PARROT", "PIG", "POLAR_BEAR", "PUFFERFISH", "RABBIT", "SALMON", "SHEEP", "SNIFFER", "SQUID", "TADPOLE", "TROPICAL_FISH", "TURTLE", "WOLF");
        register("CREATURE_UNDEAD", "BOGGED", "DROWNED", "GIANT", "HUSK", "PARCHED", "PHANTOM", "SKELETON", "STRAY", "WITHER_SKELETON", "ZOGLIN", "ZOMBIE", "ZOMBIE_VILLAGER", "ZOMBIFIED_PIGLIN");
        register("CREATURE_BUG", "BEE", "CAVE_SPIDER", "ENDERMITE", "SILVERFISH", "SPIDER");
        register("CREATURE_WATER", "AXOLOTL", "COD", "DOLPHIN", "ELDER_GUARDIAN", "GLOW_SQUID", "GUARDIAN", "NAUTILUS", "PUFFERFISH", "SALMON", "SQUID", "TADPOLE", "TROPICAL_FISH", "TURTLE");
        register("CREATURE_BOSS", "ELDER_GUARDIAN", "ENDER_DRAGON", "RAVAGER", "WITHER");
